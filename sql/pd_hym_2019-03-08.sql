...
# Database: pd_hym
# Generation Time: 2019-03-07 23:38:17 +0000
# ************************************************************
...
CREATE TABLE `system_dict` (
  ...
  `uk_mac` varchar(32) DEFAULT NULL COMMENT '唯一标识',
  `created_by` varchar(64) DEFAULT NULL COMMENT '创建人',
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_by` varchar(64) DEFAULT NULL COMMENT '更新人',
  `updated_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `table_field` varchar(64) DEFAULT NULL COMMENT '数据表名.字段名',
  `code` int(10) unsigned DEFAULT NULL COMMENT '编号',
...
# Dump of table ym_information
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ym_information`;
...
CREATE TABLE `ym_information` (
  ...
  `updated_by` varchar(64) DEFAULT NULL COMMENT '更新人',
  `updated_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `info_title` varchar(128) DEFAULT NULL COMMENT '标题',
  `info_content` varchar(1024) DEFAULT NULL COMMENT '内容',
  `view_amount` int(10) unsigned DEFAULT NULL COMMENT '浏览量',
  `comment_amount` int(10) unsigned DEFAULT NULL COMMENT '评论量',
  `up_amount` int(10) unsigned DEFAULT NULL COMMENT '点赞量',
  `down_amount` int(10) unsigned DEFAULT NULL COMMENT '踩量',
  PRIMARY KEY (`pk_id`)
